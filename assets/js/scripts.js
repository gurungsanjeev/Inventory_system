...
$(document).ready(function () {
	...
	// Listen to Customer Name text box in sale details tab
	$('#saleDetailsCustomerName').on('input', function () {
		var customerName = $(this).val().trim();
		$('#saleDetailsSaleID').val(''); // Clear Sale ID field
		$('#saleDetailsSaleIDSuggestionsDiv').fadeOut(); // Clear suggestions

		if (customerName !== '') {
			$.ajax({
				url: 'model/sale/showSaleIDsByCustomerName.php',
				method: 'POST',
				data: { customerName: customerName },
				dataType: 'json',
				success: function (data) {
					if (data && data.length > 0) {
						var suggestions = '<ul id="saleDetailsSaleIDSuggestionsList" class="list-group suggestionsList">';
						data.forEach(function (sale) {
							suggestions += `<li class="list-group-item sale-id-suggestion" data-sale-id="${sale.saleID}">${sale.saleID}</li>`;
						});
						suggestions += '</ul>';
						$('#saleDetailsSaleIDSuggestionsDiv').html(suggestions).fadeIn();
					} else {
						$('#saleDetailsSaleIDSuggestionsDiv').html('<p>No Sale IDs found</p>').fadeIn();
					}
				},
				error: function () {
					$('#saleDetailsSaleIDSuggestionsDiv').html('<p>Error fetching Sale IDs</p>').fadeIn();
				}
			});
		} else {
			$('#saleDetailsSaleIDSuggestionsDiv').fadeOut();
		}
	});

	// Handle click on Sale ID suggestion
	$(document).on('click', '.sale-id-suggestion', function () {
		var saleID = $(this).data('sale-id');
		$('#saleDetailsSaleID').val(saleID);
		$('#saleDetailsSaleIDSuggestionsDiv').fadeOut();
		getSaleDetailsToPopulate(); // Populate other fields based on Sale ID
	});

	// Optional: Make Sale ID readonly to prevent manual edits
	$('#saleDetailsSaleID').prop('readonly', true);

	// Optional: Disable existing Customer ID handler to avoid conflicts
	$('#saleDetailsCustomerID').off('keyup');

	// Update the click-outside handler to include the new suggestions
	$(document).on('click', function (e) {
		if (!$(e.target).closest('#saleDetailsCustomerName, #saleDetailsSaleIDSuggestionsDiv, #saleDetailsCustomerID, #saleDetailsCustomerIDSuggestionsDiv, #saleDetailsSaleID, #saleDetailsSaleIDSuggestionsList, #itemDetailsItemName, #itemDetailsItemNamesSuggestionsList, #itemDetailsItemNumber, #itemDetailsItemNumberSuggestionsList, #saleDetailsItemNumber, #saleDetailsItemNumberSuggestionsList, #itemImageItemNumber, #itemImageItemNumberSuggestionsList, #purchaseDetailsItemNumber, #purchaseDetailsItemNumberSuggestionsList, #customerDetailsCustomerID, #customerDetailsCustomerIDSuggestionsList, #vendorDetailsVendorID, #vendorDetailsVendorIDSuggestionsList, #purchaseDetailsPurchaseID, #purchaseDetailsPurchaseIDSuggestionsList').length) {
...
// 	// File paths (unchanged from original code)
// 	var purchaseDetailsSearchTableCreatorFile = 'model/purchase/purchaseDetailsSearchTableCreator.php';
// 	var customerDetailsSearchTableCreatorFile = 'model/customer/customerDetailsSearchTableCreator.php';
// 	var itemDetailsSearchTableCreatorFile = 'model/item/itemDetailsSearchTableCreator.php';
// 	var vendorDetailsSearchTableCreatorFile = 'model/vendor/vendorDetailsSearchTableCreator.php';
// 	var saleDetailsSearchTableCreatorFile = 'model/sale/saleDetailsSearchTableCreator.php';
// 	var purchaseReportsSearchTableCreatorFile = 'model/purchase/purchaseReportsSearchTableCreator.php';
// 	var customerReportsSearchTableCreatorFile = 'model/customer/customerReportsSearchTableCreator.php';
// 	var itemReportsSearchTableCreatorFile = 'model/item/itemReportsSearchTableCreator.php';
// 	var vendorReportsSearchTableCreatorFile = 'model/vendor/vendorReportsSearchTableCreator.php';
// 	var saleReportsSearchTableCreatorFile = 'model/sale/saleReportsSearchTableCreator.php';
// 	var vendorLastInsertedIDFile = 'model/vendor/populateLastVendorID.php';
// 	var customerLastInsertedIDFile = 'model/customer/populateLastCustomerID.php';
// 	var purchaseLastInsertedIDFile = 'model/purchase/populateLastPurchaseIDForPurchaseTab.php';
// 	var saleLastInsertedIDFile = 'model/sale/populateLastSaleIDForSaleTab.php';
// 	var itemLastInsertedIDFile = 'model/item/populateLastProductID.php';
// 	var showPurchaseIDSuggestionsFile = 'model/purchase/showPurchaseIDs.php';
// 	var showSaleIDSuggestionsFile = 'model/sale/showSaleIDs.php';
// 	var showVendorIDSuggestionsFile = 'model/vendor/showVendorIDs.php';
// 	var showCustomerIDSuggestionsFile = 'model/customer/showCustomerIDs.php';
// 	var showCustomerIDSuggestionsForSaleTabFile = 'model/customer/showCustomerIDsForSaleTab.php';
// 	var showItemNumberSuggestionsFile = 'model/item/showItemNumber.php';
// 	var showItemNumberSuggestionsForImageTabFile = 'model/item/showItemNumberForImageTab.php';
// 	var showItemNumberForPurchaseTabFile = 'model/item/showItemNumberForPurchaseTab.php';
// 	var showItemNumberForSaleTabFile = 'model/item/showItemNumberForSaleTab.php';
// 	var showItemNamesFile = 'model/item/showItemNames.php';
// 	var getItemStockFile = 'model/item/getItemStock.php';
// 	var getItemNameFile = 'model/item/getItemName.php';
// 	var updateImageFile = 'model/image/updateImage.php';
// 	var deleteImageFile = 'model/image/deleteImage.php';
// 	var purchaseFilteredReportCreatorFile = 'model/purchase/purchaseFilteredReportTableCreator.php';
// 	var saleFilteredReportCreatorFile = 'model/sale/saleFilteredReportTableCreator.php';
...
// 	// Modified showSuggestions function to include bubble sort
// 	function showSuggestions(textBoxID, scriptPath, suggestionsDivID, sortKey) {
// 		var textBoxValue = $('#' + textBoxID).val();
// 		if (textBoxValue != '') {
// 			$.ajax({
// 				url: scriptPath,
...
// 					if (data && data.length > 0) {
// 						data = bubbleSort(data, sortKey);
// 						var suggestions = '<ul id="' + suggestionsDivID + 'List" class="list-group suggestionsList">';
// 						data.forEach(function (item) {
// 							var displayValue = sortKey ? item[sortKey] : item;
// 							var dataValue = sortKey ? item[sortKey] : item;
// 							suggestions += `<li class="list-group-item" data-value="${dataValue}">${displayValue}</li>`;
// 						});
// 						suggestions += '</ul>';
// 						$('#' + suggestionsDivID).html(suggestions).fadeIn();
// 					} else {
// 						$('#' + suggestionsDivID).html('<p>No suggestions found</p>').fadeIn();
// 					}
// 				},
// 				error: function () {
// 					$('#' + suggestionsDivID).html('<p>Error fetching suggestions</p>').fadeIn();
// 				}
// 			});
// 		} else {
// 			$('#' + suggestionsDivID).fadeOut();
// 		}
// 	}
...
// 				success: function (data) {
// 					if (data && data.length > 0) {
// 						// Sort sale IDs using bubble sort
// 						data = bubbleSort(data, 'saleID');
// 						var suggestions = '<ul id="saleDetailsSaleIDSuggestionsList" class="list-group suggestionsList">';
// 						data.forEach(function (sale) {
// 							suggestions += `<li class="list-group-item sale-id-suggestion" data-sale-id="${sale.saleID}">${sale.saleID}</li>`;
// 						});
...
// 	// Listen to item name text box in item details tab
// 	$('#itemDetailsItemName').keyup(function () {
// 		showSuggestions('itemDetailsItemName', showItemNamesFile, 'itemDetailsItemNameSuggestionsDiv', 'itemName');
// 	});
...
// 	// Listen to item number text box in item details tab
// 	$('#itemDetailsItemNumber').keyup(function () {
// 		showSuggestions('itemDetailsItemNumber', showItemNumberSuggestionsFile, 'itemDetailsItemNumberSuggestionsDiv', 'itemNumber');
// 	});
...
// 	// Listen to item number text box in sale details tab
// 	$('#saleDetailsItemNumber').keyup(function () {
// 		showSuggestions('saleDetailsItemNumber', showItemNumberForSaleTabFile, 'saleDetailsItemNumberSuggestionsDiv', 'itemNumber');
// 	});
...
// 	// Listen to item number text box in item image tab
// 	$('#itemImageItemNumber').keyup(function () {
// 		showSuggestions('itemImageItemNumber', showItemNumberSuggestionsForImageTabFile, 'itemImageItemNumberSuggestionsDiv', 'itemNumber');
// 	});
...
// 	// Listen to item number text box in purchase details tab
// 	$('#purchaseDetailsItemNumber').keyup(function () {
// 		showSuggestions('purchaseDetailsItemNumber', showItemNumberForPurchaseTabFile, 'purchaseDetailsItemNumberSuggestionsDiv', 'itemNumber');
// 	});
...
// 	// Listen to CustomerID text box in customer details tab
// 	$('#customerDetailsCustomerID').keyup(function () {
// 		showSuggestions('customerDetailsCustomerID', showCustomerIDSuggestionsFile, 'customerDetailsCustomerIDSuggestionsDiv', 'customerID');
// 	});
...
// 	// Listen to CustomerID text box in sale details tab
// 	$('#saleDetailsCustomerID').keyup(function () {
// 		showSuggestions('saleDetailsCustomerID', showCustomerIDSuggestionsForSaleTabFile, 'saleDetailsCustomerIDSuggestionsDiv', 'customerID');
// 	});
...
// 	// Listen to VendorID text box in vendor details tab
// 	$('#vendorDetailsVendorID').keyup(function () {
// 		showSuggestions('vendorDetailsVendorID', showVendorIDSuggestionsFile, 'vendorDetailsVendorIDSuggestionsDiv', 'vendorID');
// 	});
...
// 	// Listen to PurchaseID text box in purchase details tab
// 	$('#purchaseDetailsPurchaseID').keyup(function () {
// 		showSuggestions('purchaseDetailsPurchaseID', showPurchaseIDSuggestionsFile, 'purchaseDetailsPurchaseIDSuggestionsDiv', 'purchaseID');
// 	});
...
// 	// Listen to saleID text box in sale details tab
// 	$('#saleDetailsSaleID').keyup(function () {
// 		showSuggestions('saleDetailsSaleID', showSaleIDSuggestionsFile, 'saleDetailsSaleIDSuggestionsDiv', 'saleID');
// 	});
...
// // Function to process imageURL in DB
// function processImage(imageFormID, scriptPath, messageDivID) {
// 	var form = $('#' + imageFormID)[0];
// 	var formData = new FormData(form);
// 	$.ajax({
...
// // Function to create searchable datatables
// function searchTableCreator(tableContainerDiv, tableCreatorFileUrl, table) {
// 	var tableContainerDivID = '#' + tableContainerDiv;
// 	var tableID = '#' + table;
// 	$(tableContainerDivID).load(tableCreatorFileUrl, function () {
...
// // Function to create reports datatables
// function reportsTableCreator(tableContainerDiv, tableCreatorFileUrl, table) {
// 	var tableContainerDivID = '#' + tableContainerDiv;
// 	var tableID = '#' + table;
// 	$(tableContainerDivID).load(tableCreatorFileUrl, function () {
...
// 				};
// 				quantityTotal = api.column(6).data().reduce(function (a, b) { return intVal(a) + intVal(b); }, 0);
// 				quantityFilteredTotal = api.column(6, { page: 'current' }).data().reduce(function (a, b) { return intVal(a) + intVal(b); }, 0);
// 				unitPriceTotal = api.column(7).data().reduce(function (a, b) { return intVal(a) + intVal(b); }, 0);
// 				unitPriceFilteredTotal = api.column(7, { page: 'current' }).data().reduce(function (a, b) { return intVal(a) + intVal(b); }, 0);
// 				fullPriceTotal = api.column(8).data().reduce(function (a, b) { return intVal(a) + intVal(b); }, 0);
// 				fullPriceFilteredTotal = api.column(8, { page: 'current' }).data().reduce(function (a, b) { return intVal(a) + intVal(b); }, 0);
// 				$(api.column(6).footer()).html(quantityFilteredTotal + ' (' + quantityTotal + ' total)');
// 				$(api.column(7).footer()).html(unitPriceFilteredTotal + ' (' + unitPriceTotal + ' total)');
// 				$(api.column(8).footer()).html(fullPriceFilteredTotal + ' (' + fullPriceTotal + ' total)');
// 			}
...
// 					return typeof i === 'string' ? i.replace(/[\$,]/g, '') * 1 : typeof i === 'number' ? i : 0;
// 				};
// 				quantityTotal = api.column(7).data().reduce(function (a, b) { return intVal(a) + intVal(b); }, 0);
// 				quantityFilteredTotal = api.column(7, { page: 'current' }).data().reduce(function (a, b) { return intVal(a) + intVal(b); }, 0);
// 				unitPriceTotal = api.column(8).data().reduce(function (a, b) { return intVal(a) + intVal(b); }, 0);
// 				unitPriceFilteredTotal = api.column(8, { page: 'current' }).data().reduce(function (a, b) { return intVal(a) + intVal(b); }, 0);
// 				fullPriceTotal = api.column(9).data().reduce(function (a, b) { return intVal(a) + intVal(b); }, 0);
// 				fullPriceFilteredTotal = api.column(9, { page: 'current' }).data().reduce(function (a, b) { return intVal(a) + intVal(b); }, 0);
// 				$(api.column(7).footer()).html(quantityFilteredTotal + ' (' + quantityTotal + ' total)');
// 				$(api.column(8).footer()).html(unitPriceFilteredTotal + ' (' + unitPriceTotal + ' total)');
// 				$(api.column(9).footer()).html(fullPriceFilteredTotal + ' (' + fullPriceTotal + ' total)');
// 			}
...
// // Function to insert customer data to db
// function addCustomer() {
// 	var customerDetailsCustomerFullName = $('#customerDetailsCustomerFullName').val();
// 	var customerDetailsCustomerEmail = $('#customerDetailsCustomerEmail').val();
// 	var customerDetailsCustomerMobile = $('#customerDetailsCustomerMobile').val();
...
// // Function to insert vendor data to db
// function addVendor() {
// 	var vendorDetailsVendorFullName = $('#vendorDetailsVendorFullName').val();
// 	var vendorDetailsVendorEmail = $('#vendorDetailsVendorEmail').val();
// 	var vendorDetailsVendorMobile = $('#vendorDetailsVendorMobile').val();
...
// // Function to insert item data to db
// function addItem() {
// 	var itemDetailsItemNumber = $('#itemDetailsItemNumber').val();
// 	var itemDetailsItemName = $('#itemDetailsItemName').val();
// 	var itemDetailsDiscount = $('#itemDetailsDiscount').val();
...
// // Function to insert purchase data to db
// function addPurchase() {
// 	var purchaseDetailsItemNumber = $('#purchaseDetailsItemNumber').val();
// 	var purchaseDetailsPurchaseDate = $('#purchaseDetailsPurchaseDate').val();
// 	var purchaseDetailsItemName = $('#purchaseDetailsItemName').val();
...
// // Function to insert sale data to db
// function addSale() {
// 	var saleDetailsItemNumber = $('#saleDetailsItemNumber').val();
// 	var saleDetailsItemName = $('#saleDetailsItemName').val();
// 	var saleDetailsDiscount = $('#saleDetailsDiscount').val();
...
// // Function to get item details for item details tab
// function getItemDetailsToPopulate() {
// 	var itemNumber = $('#itemDetailsItemNumber').val();
// 	var defaultImgUrl = 'data/item_images/imageNotAvailable.jpg';
// 	var defaultImageData = '<img class="img-fluid" src="data/item_images/imageNotAvailable.jpg">';
...
// // Function to get item details for sale details tab
// function getItemDetailsToPopulateForSaleTab() {
// 	var itemNumber = $('#saleDetailsItemNumber').val();
// 	var defaultImgUrl = 'data/item_images/imageNotAvailable.jpg';
// 	var defaultImageData = '<img class="img-fluid" src="data/item_images/imageNotAvailable.jpg">';
...
// // Function to get customer details for customer details tab
// function getCustomerDetailsToPopulate() {
// 	var customerDetailsCustomerID = $('#customerDetailsCustomerID').val();
// 	$.ajax({
// 		url: 'model/customer/populateCustomerDetails.php',
...
// // Function to get customer details for sale details tab
// function getCustomerDetailsToPopulateSaleTab() {
// 	var customerDetailsCustomerID = $('#saleDetailsCustomerID').val();
// 	$.ajax({
// 		url: 'model/customer/populateCustomerDetails.php',
...
// // Function to get vendor details for vendor details tab
// function getVendorDetailsToPopulate() {
// 	var vendorDetailsVendorID = $('#vendorDetailsVendorID').val();
// 	$.ajax({
// 		url: 'model/vendor/populateVendorDetails.php',
...
// // Function to get purchase details for purchase details tab
// function getPurchaseDetailsToPopulate() {
// 	var purchaseDetailsPurchaseID = $('#purchaseDetailsPurchaseID').val();
// 	$.ajax({
// 		url: 'model/purchase/populatePurchaseDetails.php',
...
// // Function to get sale details for sale details tab
// function getSaleDetailsToPopulate() {
// 	var saleDetailsSaleID = $('#saleDetailsSaleID').val();
// 	$.ajax({
// 		url: 'model/sale/populateSaleDetails.php',
...
// // Function to update item data in db
// function updateItem() {
// 	var itemDetailsItemNumber = $('#itemDetailsItemNumber').val();
// 	var itemDetailsItemName = $('#itemDetailsItemName').val();
// 	var itemDetailsDiscount = $('#itemDetailsDiscount').val();
...
// // Function to update customer data in db
// function updateCustomer() {
// 	var customerDetailsCustomerID = $('#customerDetailsCustomerID').val();
// 	var customerDetailsCustomerFullName = $('#customerDetailsCustomerFullName').val();
// 	var customerDetailsCustomerMobile = $('#customerDetailsCustomerMobile').val();
...
// // Function to update vendor data in db
// function updateVendor() {
// 	var vendorDetailsVendorID = $('#vendorDetailsVendorID').val();
// 	var vendorDetailsVendorFullName = $('#vendorDetailsVendorFullName').val();
// 	var vendorDetailsVendorMobile = $('#vendorDetailsVendorMobile').val();
...
// // Function to update purchase data in db
// function updatePurchase() {
// 	var purchaseDetailsItemNumber = $('#purchaseDetailsItemNumber').val();
// 	var purchaseDetailsPurchaseDate = $('#purchaseDetailsPurchaseDate').val();
// 	var purchaseDetailsItemName = $('#purchaseDetailsItemName').val();
...
// // Function to update sale data in db
// function updateSale() {
// 	var saleDetailsItemNumber = $('#saleDetailsItemNumber').val();
// 	var saleDetailsSaleDate = $('#saleDetailsSaleDate').val();
// 	var saleDetailsItemName = $('#saleDetailsItemName').val();

...
---------------------------------------------------------------------------------->
								...
								<form>
									...
									<div class="form-row">
										...
										<div class="form-group col-md-2">
											...
											<input type="number" class="form-control" id="saleDetailsDiscount"
												name="saleDetailsDiscount" min="0" value="0">
										</div>
										<div class="form-group col-md-2">
										...
										<div class="form-group col-md-2">
											...
											<input type="text" class="form-control" id="saleDetailsUnitPrice"
												name="saleDetailsUnitPrice" min="0" value="0">
										</div>
										<div class="form-group col-md-3">
					...
					<div class="tab-pane fade" id="v-pills-search" role="tabpanel" aria-labelledby="v-pills-search-tab">
						<div class="card card-outline-secondary my-4">
							<div class="card-header">Search Inventory<button id="searchTablesRefresh"
											...
											<div class="form-row">
												<div class="form-group col-md-3">
													...
													<input type="date" class="form-control datepicker"
														id="saleReportStartDate" value="2025-05-14"
														name="saleReportStartDate" readonly>
												</div>
												<div class="form-group col-md-3">
													<label for="saleReportEndDate">End Date</label>
													<input type="date" class="form-control datepicker"
														id="saleReportEndDate" value="2025-05-14"
										...
										<form>
											<div class="form-row">
												<div class="form-group col-md-3">
													...
													<input type="text" class="form-control datepicker"
														id="purchaseReportStartDate" value="2025-05-14"
														name="purchaseReportStartDate" readonly>
												</div>
												<div class="form-group col-md-3">
													<label for="purchaseReportEndDate">End Date</label>
													<input type="text" class="form-control datepicker"
														id="purchaseReportEndDate" value="2025-05-14"
